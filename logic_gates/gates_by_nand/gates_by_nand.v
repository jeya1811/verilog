...
wire [Width-1:0] op_n;
nand_gate #(.Width(Width)) u1(.ip0(ip0), .ip1(ip1), .op(op_n));
nand_gate #(.Width(Width)) u2(.ip0(op_n), .ip1(op_n), .op(op));
endmodule
...
nand_gate #(.Width(Width)) u1(.ip0(ip0), .ip1(ip0), .op(ip0_n));
nand_gate #(.Width(Width)) u2(.ip0(ip1), .ip1(ip1), .op(ip1_n));
nand_gate #(.Width(Width)) u3(.ip0(ip0_n), .ip1(ip1_n), .op(op));
endmodule
...
nand_gate #(.Width(Width)) u1(.ip0(ip0), .ip1(ip0), .op(op));
endmodule
...
nand_gate #(.Width(Width)) u1(.ip0(ip0), .ip1(ip0), .op(ip0_n));
nand_gate #(.Width(Width)) u2(.ip0(ip1), .ip1(ip1), .op(ip1_n));
nand_gate #(.Width(Width)) u3(.ip0(ip0_n), .ip1(ip1_n), .op(op_n));
nand_gate #(.Width(Width)) u4(.ip0(op_n), .ip1(op_n), .op(op));
endmodule
...
nand_gate #(.Width(Width)) u1(.ip0(ip0), .ip1(ip1), .op(t0));
nand_gate #(.Width(Width)) u2(.ip0(ip0), .ip1(t0), .op(t1));
nand_gate #(.Width(Width)) u3(.ip0(t0), .ip1(ip1), .op(t2));
nand_gate #(.Width(Width)) u4(.ip0(t1), .ip1(t2), .op(op));
endmodule
...
nand_gate #(.Width(Width)) u2(.ip0(ip0), .ip1(t0), .op(t1));
nand_gate #(.Width(Width)) u3(.ip0(t0), .ip1(ip1), .op(t2));
nand_gate #(.Width(Width)) u4(.ip0(t1), .ip1(t2), .op(op_n));
nand_gate #(.Width(Width)) u5(.ip0(op_n), .ip1(op_n), .op(op));
endmodule
...
integer i;
gates_by_nand #(.Width(Width)) dut(.ip0(ip0), .ip1(ip1), .op_and(op_and), .op_or(op_or), .op_not(op_not), .op_nand(op_nand), .op_nor(op_nor), .op_xor(op_xor), .op_xnor(op_xnor));
