...
nor_gate #(.Width(Width)) u1(.in0(in0), .in1(in0), .out(in0_n));
nor_gate #(.Width(Width)) u2(.in0(in1), .in1(in1), .out(in1_n));
nor_gate #(.Width(Width)) u3(.in0(in0_n), .in1(in1_n), .out(out));
endmodule
...
nor_gate #(.Width(Width)) u1(.in0(in0), .in1(in1), .out(out_n));
nor_gate #(.Width(Width)) u2(.in0(out_n), .in1(out_n), .out(out));
endmodule
...
nor_gate #(.Width(Width)) u1(.in0(in), .in1(in), .out(out));
endmodule
...
nor_gate #(.Width(Width)) u1(.in0(in0), .in1(in0), .out(in0_n));
nor_gate #(.Width(Width)) u2(.in0(in1), .in1(in1), .out(in1_n));
nor_gate #(.Width(Width)) u3(.in0(in0_n), .in1(in1_n), .out(out_n));
nor_gate #(.Width(Width)) u4(.in0(out_n), .in1(out_n), .out(out));
endmodule
...
nor_gate #(.Width(Width)) u1(.in0(in0), .in1(in1), .out(t0));
nor_gate #(.Width(Width)) u2(.in0(in0), .in1(t0), .out(t1));
nor_gate #(.Width(Width)) u3(.in0(t0), .in1(in1), .out(t2));
nor_gate #(.Width(Width)) u4(.in0(t1), .in1(t2), .out(out_n));
nor_gate #(.Width(Width)) u5(.in0(out_n), .in1(out_n), .out(out));
endmodule
...
nor_gate #(.Width(Width)) u2(.in0(in0), .in1(t0), .out(t1));
nor_gate #(.Width(Width)) u3(.in0(t0), .in1(in1), .out(t2));
nor_gate #(.Width(Width)) u4(.in0(t1), .in1(t2), .out(out));
endmodule
...
integer i;
gates_by_nor #(.Width(Width)) dut(.in0(in0), .in1(in1), .out_and(out_and), .out_or(out_or), .out_not(out_not), .out_nand(out_nand), .out_nor(out_nor), .out_xor(out_xor), .out_xnor(out_xnor));
