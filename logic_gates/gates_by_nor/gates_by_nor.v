...
nor_gate #(.Width(Width)) u1(.a(a), .b(a), .y(a_n));
nor_gate #(.Width(Width)) u2(.a(b), .b(b), .y(b_n));
nor_gate #(.Width(Width)) u3(.a(a_n), .b(b_n), .y(y));
endmodule
...
wire [Width-1:0] y_n;
nor_gate #(.Width(Width)) u1(.a(a), .b(b), .y(y_n));
nor_gate #(.Width(Width)) u2(.a(y_n), .b(y_n), .y(y));
endmodule
...
nor_gate #(.Width(Width)) u1(.a(a), .b(a), .y(y));
endmodule
...
nor_gate #(.Width(Width)) u1(.a(a), .b(a), .y(a_n));
nor_gate #(.Width(Width)) u2(.a(b), .b(b), .y(b_n));
nor_gate #(.Width(Width)) u3(.a(a_n), .b(b_n), .y(y_n));
nor_gate #(.Width(Width)) u4(.a(y_n), .b(y_n), .y(y));
endmodule
...
nor_gate #(.Width(Width)) u1(.a(a), .b(b), .y(y1));
nor_gate #(.Width(Width)) u2(.a(a), .b(y1), .y(y2));
nor_gate #(.Width(Width)) u3(.a(y1), .b(b), .y(y3));
nor_gate #(.Width(Width)) u4(.a(y2), .b(y3), .y(y_n));
nor_gate #(.Width(Width)) u5(.a(y_n), .b(y_n), .y(y));
endmodule
...
nor_gate #(.Width(Width)) u2(.a(a), .b(y1), .y(y2));
nor_gate #(.Width(Width)) u3(.a(y1), .b(b), .y(y3));
nor_gate #(.Width(Width)) u4(.a(y2), .b(y3), .y(y));
endmodule
...
integer i;
gates_by_nor #(.Width(Width)) dut(.a(a), .b(b), .y_and(y_and), .y_or(y_or), .y_not(y_not), .y_nand(y_nand), .y_nor(y_nor), .y_xor(y_xor), .y_xnor(y_xnor));
